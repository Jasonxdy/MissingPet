		...
		<div class="container-fluid mt-5 pl-5 pr-5 pb-3" style="margin-left:20rem">
              <div class="row card bg-light">
                ...
                <div class="col-md-12">
	                ...
	                <li>
	                	<!-- 맨 처음으로(<<) -->
	                    <a class="page-link" href="<%= request.getContextPath() %>/seeBoard/searchList?searchKey=<%=searchKey %>&searchValue=<%=searchValue %>&currentPage=1">&lt;&lt;</a>
	                </li>
	                
	                <li>
	                	<!-- 이전으로(<) -->
                   		<a class="page-link" href="<%= request.getContextPath() %>/seeBoard/searchList?searchKey=<%=searchKey %>&searchValue=<%=searchValue %>&currentPage=<%= currentPage-1 %>">&lt;</a>
	                </li>
	                <% } %>
	                ...
	                <% for(int p = startPage; p <= endPage; p++){ %>
	                	...
	                	<% } else{ %>
                		<li>
	                    	<a class="page-link" href="<%= request.getContextPath() %>/seeBoard/searchList?searchKey=<%=searchKey %>&searchValue=<%=searchValue %>&currentPage=<%= p %>"><%= p %></a>
	                	</li>
	                	<% } %>
					<%} %>
	                ...
	                <!-- 맨 끝으로(>>) -->
	                <li>
	                    <a class="page-link" href="<%= request.getContextPath() %>/seeBoard/searchList?searchKey=<%=searchKey %>&searchValue=<%=searchValue %>&currentPage=<%= maxPage %>">&gt;&gt;</a>
	                </li>
	                <% }%>
