                  ...
                  <section class="content">
                    ...
                    <div class="col-md-8 col-md-offset-2" id="panelwrap">
                        ...
                        <table id="tb">
                          ...
                          <%
                          	String phone[] = seeBoard.getsBoardPhone().split("-");               
                          %>
                          ...
                          <tr>
							...
							<%
								String place[] = seeBoard.getsBoardLocation().split(",");
							%>
                    ...
                    <div class="col-md-4" id="right-ban">
                      ...
                      <div id="bottom-bt">
                        ...
                        <a href="detail?no=<%= seeBoard.getBoardNo() %>" class="btn btn-primary">취소</a>
...
$('document').ready(function() {
 var area0 = ["시/도 선택","서울특별시","인천광역시","대전광역시","광주광역시","대구광역시","울산광역시","부산광역시","경기도","강원도","충청북도","충청남도","전라북도","전라남도","경상북도","경상남도","제주도"];
  var area1 = ["강남구","강동구","강북구","강서구","관악구","광진구","구로구","금천구","노원구","도봉구","동대문구","동작구","마포구","서대문구","서초구","성동구","성북구","송파구","양천구","영등포구","용산구","은평구","종로구","중구","중랑구"];
   ...
   var breed1 = ["골든리트리버","그레이 하운드","그레이트 덴","그레이트 피레니즈","꼬통 드 뚤레아","네오폴리탄 마스티프","노르포크 테리어","노리치 테리어","뉴펀들랜드","닥스훈트","달마시안","댄디 딘몬트 테리어","도고 아르젠티노","도베르만","도사","동경견","라브라도 리트리버","라바 압소","라이카","래빗 닥스훈트","랫 테리어","레이크랜드 테리어","로디지안 리즈백","로트바일러","마리노이즈","마스티프","말라뮤트","말티즈","맨체스터테리어","미니어쳐 닥스훈트","미니어쳐 불 테리어","미니어쳐 슈나우저"];
...
$(function () {
	...
	if('<%= seeBoard.getsBoardLocationTell() %>' == 'Y'){
		$("#locationTell").attr("checked",true);
	}
	if('<%= seeBoard.getsBoardBreedTell() %>' == 'Y'){
		$("#breedTell").attr("checked",true);
	}
	if('<%= seeBoard.getsBoardCommentTell() %>' == 'Y'){
