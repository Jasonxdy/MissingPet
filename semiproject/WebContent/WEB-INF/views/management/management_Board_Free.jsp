...
<%@page import="java.util.*, java.sql.*, com.kh.semiproject.board.model.vo.Board"%>
 <% 
	List<Board> FreeBoardList = (List<Board>) request.getAttribute("FreeBoardList"); 
 %>
         ...
         <div class="container-fluid row-md-2" style="height: 1000px;">
                ...
                <%@ include file="../common/sidebar.jsp"%>
                 ...
                 <!-- 검색창-->
                            ...
                            <form class="col" method="POST" action="searchFreeBoard" style="border: 1px solid yellowgreen;">
   						 ...
   						 <table class="row-md-10 table" style="height: 15px;">
                              ...
                              <% if (FreeBoardList.isEmpty()) { %>
								...
								<% } else { %>
                                  ...
                                  <tr>
                                      <td><%= FreeBoardList.get(i).getBoardNo() %></td>
                                      <td><span class="ContentLength"><%= FreeBoardList.get(i).getBoardTitle() %></span></td>
                                      <td><span class="ContentLength"><%= FreeBoardList.get(i).getBoardContent() %></span></td>
                                      <td><%= FreeBoardList.get(i).getMemberId() %></td>
                                      <td><%= FreeBoardList.get(i).getBoardCreateDt() %></td>
