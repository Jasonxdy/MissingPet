	...
	font-family: 'Sunflower', sans-serif;
     ...
     <div class="container-fluid row-md-2" style="height: 1000px;">
                ...
                <!-- 검색창-->
                          ...
                          <form class="col" method="POST" action="searchSeeBoard" style="border: 1px solid yellowgreen;">
                            ...
                            <table class="row-md-10 table" style="height: 15px;">
                              ...
                              <tbody>
								...
								<% } else { %>
                                  ...
                                  <tr>
                                      <td><%= SeeBoardList.get(i).getBoardNo() %></td>
                                      <td><span class="ContentLength"><%= SeeBoardList.get(i).getBoardTitle() %></span></td>
                                      <td><span class="ContentLength"><%= SeeBoardList.get(i).getBoardContent() %></span></td>
                                      <td><%= SeeBoardList.get(i).getMemberId() %></td>
                                      <td><%= SeeBoardList.get(i).getBoardCreateDt() %></td>
