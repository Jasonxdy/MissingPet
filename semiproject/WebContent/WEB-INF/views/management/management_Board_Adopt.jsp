...
<% 
	List<Board> AdoptBoardList = (List<Board>) request.getAttribute("AdoptBoardList"); 
%>
<!DOCTYPE html>
<html>
<head>
                         ...
                         <table class="row-md-10 table" style="height: 15px;">
                              ...
                              <% if (AdoptBoardList.isEmpty()) { %>
								...
								<% } else { %>
                                  ...
                                  <tr>
                                      <td><%= AdoptBoardList.get(i).getBoardNo() %></td>
                                      <td><span class="ContentLength"><%= AdoptBoardList.get(i).getBoardTitle() %></span></td>
