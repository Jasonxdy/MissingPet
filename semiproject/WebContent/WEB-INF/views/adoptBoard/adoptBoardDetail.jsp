					...
					<div class="row">
						...
						<div class="col-md-4" id="right-tab">
							<table>
								...
								<tr>
									<th>연락처</th>
									<td><%= adoptBoard.getaBoardPhone() %></td>
								</tr>
								<tr>
									<th>이메일</th>
								...
								<tr>
									<th>분양장소</th>
									<td><%= adoptBoard.getaBoardLocation() %></td>
								</tr>
								<tr>
									<th>동물 종류</th>
								...
								<tr>
									<th>건강상태</th>
									<td><%= adoptBoard.getaBoardHealth() %></td>
								</tr>
								<tr>
									<th>분양금</th>
...
<script>
		...
		$("#addComment").on("click", function(){
			...
			var alertURL = "<%= request.getContextPath() %>" + "/adoptBoard/detail?no=" + boardNo + "&currentPage=1";
